...
public class InvitationController {
    ...
    public String prepareInvitationAccess(Model model, @ModelAttribute("accessToken") String accessToken, HttpServletRequest req, Authentication auth) throws InvitationTokenDoesNotExistException, InvalidCallStateException, InvalidUserException, InvitationDoesNotExistException, UserDoesNotExistException {
        return joinCall(model, accessToken, auth, req);
    }

    private String joinCall(Model model, String accessToken, Authentication auth, HttpServletRequest req) throws InvalidCallStateException, InvalidUserException, InvitationTokenDoesNotExistException, InvitationDoesNotExistException, UserDoesNotExistException {
        User user;
        if (auth == null) {
